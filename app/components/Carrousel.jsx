...
const Carrousel = () => {
	return (
		<div className="carousel relative container mx-auto m-w-[100vw]">
			<div className="carousel-inner relative overflow-hidden w-full m-w-[100vw]">
				<input
					...
					defaultChecked
				/>
				<div className="carousel-item absolute opacity-0 h-[50vh]">
					<div
				...
				<input
					...
					hidden={true}
				/>
				<div className="carousel-item absolute opacity-0 bg-cover bg-right h-[50vh]">
					<div
						className="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right"
						style={{
