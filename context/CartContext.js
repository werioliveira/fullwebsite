...
export const CartProvider = ({ children }) => {
	...
	const addItemToWishList = async ({
		...
		if (isItemExist) {
			...
			localStorage.setItem("wishList", JSON.stringify({ wishItems: newWishItems }));
			setWishListToState();
		}
	...
	return (
		<CartContext.Provider value={{ cart,wishList, addItemToCart, deleteItemFromCart, addItemToWishList, deleteItemFromWishList }}>
			{children}
